...
class ModelDB: public DB {
 public:
  ...
  //TODO
  virtual Status WriteToLog(const leveldb::WriteOptions&,
		           leveldb::WriteBatch*, uint64_t&) {
	  return Status::OK();
  }

  virtual Status SetLogVisible(const uint64_t num) {
          return Status::OK();
  }
